...
fn main() {
    ...
    while reading_folds {
        ...
        let pmat = mat.clone();
        print_matrix(pmat, lowestxfold, lowestyfold);
    }

    println!("Size left {},{}", lowestxfold, lowestyfold);
    print_matrix(mat, lowestxfold, lowestyfold);
    // println!("{}", count);
}

fn print_matrix(mat: Matrix<u8>, maxx: usize, maxy: usize) {
    for y in 0..maxy {
        for x in 0..maxx {
